...
import { BarChart3, BookOpen, Bot, FileText, Globe2, Home, LayoutDashboard, Search, ShieldCheck, Users } from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/articles/new", label: "Content Workflow", icon: FileText },
