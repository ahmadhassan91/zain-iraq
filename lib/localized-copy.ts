...
export const customerCopy = {
  EN: {
    ...
    noResultsTitle: "No exact match found",
    noResultsBody: "Try another keyword, browse the suggested support topics, or submit missing-content feedback.",
    whatsNew: "What's New",
  ...
  AR: {
    ...
    resultsFor: "نتائج عن",
    noResultsTitle: "لم يتم العثور على نتيجة مطابقة",
    noResultsBody: "جرّب كلمة أخرى، تصفح مواضيع الدعم المقترحة، أو أرسل ملاحظة عن المحتوى الناقص.",
    whatsNew: "ما الجديد",
  ...
  KU: {
    ...
    resultsFor: "ئەنجام بۆ",
    noResultsTitle: "ئەنجامی هاوتا نەدۆزرایەوە",
    noResultsBody: "وشەیەکی تر تاقی بکەوە، بابەتە پێشنیارکراوەکانی پشتگیری ببینە، یان بۆچوونی ناوەڕۆکی کەم بنێرە.",
    whatsNew: "چی نوێیە",
