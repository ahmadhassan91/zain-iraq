...
const articleTranslations: Record<string, Partial<Record<Language, Partial<Article>>>> = {
  "roaming-activation": {
    AR: {
      ...
      customerAnswer: "قبل السفر، افتح تطبيق زين العراق أو تواصل مع الدعم للتأكد من تفعيل التجوال. بعد الوصول أعد تشغيل الجهاز واختر شبكة شريك إذا لم يتصل تلقائياً.",
      internalNote: "تحقق من حالة الخط، أهلية التجوال، حدود الصرف والباقات الفعالة قبل التصعيد.",
      steps: ["تأكيد أن خط العميل فعال", "فحص أهلية التجوال", "تأكيد تغطية الوجهة", "طلب إعادة تشغيل الجهاز", "التصعيد إذا فشل الاتصال بشبكة الشريك"]
    },
    KU: {
      title: "چۆنیەتی چالاککردنی ڕۆمینگ",
      category: "ڕۆمینگ",
      summary: "ڕێنمایی کڕیار بۆ ئامادەیی ڕۆمینگ، پشکنینی چالاککردن و پشتگیری گەشت.",
      customerAnswer: "پێش گەشت، ئەپی زەین عێراق بکەرەوە یان پەیوەندی بە پشتگیری بکە بۆ دڵنیابوون لە چالاکی ڕۆمینگ. دوای گەیشتن ئامێرەکە دووبارە داگیرسێنەوە و ئەگەر خۆکار نەبەسترا، تۆڕی هاوبەش هەڵبژێرە.",
      internalNote: "پێش بەرزکردنەوە دۆخی هێڵ، شیاوی ڕۆمینگ، سنووری خەرجی و پاکێجی چالاک بپشکنە.",
      steps: ["دڵنیابوون لە چالاکی هێڵی کڕیار", "پشکنینی شیاوی ڕۆمینگ", "پشتڕاستکردنەوەی داپۆشینی شوێنی گەشت", "داواکردنی دووبارە داگیرساندنەوەی ئامێر", "بەرزکردنەوە ئەگەر پەیوەندی تۆڕی هاوبەش سەرنەکەوت"]
    }
  },
  "slow-internet": {
    AR: {
      ...
      customerAnswer: "أعد تشغيل الجهاز، تأكد من تفعيل بيانات الهاتف، افحص رصيد الباقة، ثم فعّل وضع الطيران وأوقفه بعد 10 ثوانٍ.",
      internalNote: "افحص التغطية، رصيد الباقة، حظر الشبكة، حالة الشريحة وإعدادات APN قبل إنشاء تذكرة شبكة.",
      steps: ["فحص الباقة الفعالة", "تأكيد تغطية الشبكة", "تأكيد إعدادات APN", "تجربة الشريحة في جهاز آخر", "إنشاء تذكرة فنية إذا استمرت المشكلة"]
    },
    KU: {
      ...
      customerAnswer: "ئامێرەکە دووبارە داگیرسێنەوە، دڵنیا ببە داتای مۆبایل چالاکە، باڵانسی پاکێج بپشکنە و فڕۆکەیی بۆ 10 چرکە چالاک و ناچالاک بکە.",
      internalNote: "پێش دروستکردنی تیکەتی تۆڕ، داپۆشین، باڵانسی پاکێج، قەدەغەی تۆڕ، دۆخی SIM و APN بپشکنە.",
      steps: ["پشکنینی پاکێجی چالاک", "پشتڕاستکردنەوەی داپۆشینی تۆڕ", "پشتڕاستکردنەوەی ڕێکخستنی APN", "تاقیکردنەوەی SIM لە ئامێرێکی تر", "دروستکردنی تیکەتی تەکنیکی ئەگەر کێشەکە بەردەوام بوو"]
    }
  },
  "sim-replacement": {
    AR: {
      ...
      customerAnswer: "يرجى زيارة أقرب فرع زين مع هوية صالحة. سيقوم فريق الفرع بالتحقق من الملكية وإكمال استبدال الشريحة.",
      internalNote: "لا تشارك قواعد التحقق الداخلية عبر القنوات العامة.",
      steps: ["تأكيد سبب الاستبدال", "توجيه العميل لأقرب فرع", "شرح متطلب الهوية", "تسجيل ملاحظة التفاعل"]
    },
    KU: {
      ...
      customerAnswer: "تکایە لەگەڵ ناسنامەی دروست بچۆ بۆ نزیکترین لقەی زەین. تیمی لق خاوەندارێتی پشتڕاست دەکاتەوە و گۆڕینی SIM تەواو دەکات.",
      internalNote: "یاساکانی پشتڕاستکردنەوەی ناوخۆ لە کەناڵە گشتییەکاندا مەڵێ.",
      steps: ["پشتڕاستکردنەوەی هۆکاری گۆڕین", "ڕێنمایی کڕیار بۆ نزیکترین لق", "ڕوونکردنەوەی پێویستی ناسنامە", "تۆمارکردنی تێبینی پەیوەندی"]
    }
  },
  "app-login": {
    AR: {
  ...
  "balance-deduction": {
    AR: {
      ...
      customerAnswer: "يمكننا مراجعة استخدامك الأخير والخدمات الفعالة. قد يكون الخصم مرتبطاً بتجديد باقة أو خدمة مضافة أو استخدام خارج الباقة.",
      internalNote: "افحص سجل الشحن والخدمات المضافة الفعالة قبل مناقشة الاسترداد.",
      steps: ["فتح سجل الشحن", "مراجعة تجديد الباقة", "فحص الخدمات المضافة", "شرح سبب الخصم", "تصعيد نزاع الفوترة إذا لم يحل"]
    },
    KU: {
      title: "کەمبوونەوەی چاوەڕواننەکراوی باڵانس",
      category: "پارەدان",
      summary: "ڕێنمایی ئەجێنت بۆ پشکنینی سکاڵای کەمبوونەوەی باڵانس.",
      customerAnswer: "دەتوانین بەکارهێنانی دوایی و خزمەتگوزارییە چالاکەکانت بپشکنین. کەمبوونەوە ڕەنگە بە نوێکردنەوەی پاکێج، خزمەتی زیادە یان بەکارهێنانی دەرەوەی پاکێج پەیوەندیدار بێت.",
      internalNote: "پێش گفتوگۆی گەڕاندنەوەی پارە، مێژووی تێچوون و خزمەتگوزاری زیادەی چالاک بپشکنە.",
      steps: ["کردنەوەی مێژووی تێچوون", "پێداچوونەوەی نوێکردنەوەی پاکێج", "پشکنینی خزمەتگوزاری زیادە", "ڕوونکردنەوەی هۆکاری کەمبوونەوە", "بەرزکردنەوەی ناکۆکی پارەدان ئەگەر چارە نەبوو"]
    }
  },
  "international-calls": {
    AR: {
  ...
  "super-card": {
    AR: {
      ...
      category: "الباقات",
      summary: "أسئلة عامة للاشتراك والتجديد والتحقق من الوحدات المتبقية.",
      customerAnswer: "استخدم قناة الاشتراك المعتمدة في تطبيق زين العراق أو صفحة الدعم الرسمية لتفعيل الباقة.",
      internalNote: "تأكد من أحدث الأكواد التجارية قبل مشاركتها عبر القنوات المساعدة.",
      steps: ["اختيار الباقة", "تأكيد الرصيد", "الاشتراك عبر التطبيق أو SMS", "فحص حالة التجديد"]
    },
    KU: {
      title: "پشتگیری پاکێجی Super Card",
      category: "پاکێجەکان",
      summary: "پرسیارە گشتییەکان بۆ بەشداری، نوێکردنەوە و پشکنینی یەکە ماوەکان.",
      customerAnswer: "بۆ چالاککردنی پاکێج، کەناڵی بەشداری پەسەندکراو لە ئەپی زەین عێراق یان لاپەڕەی پشتگیری فەرمی بەکاربهێنە.",
      internalNote: "پێش هاوبەشکردن لە کەناڵە یارمەتیدەرەکان، نوێترین کۆدە بازرگانییەکان پشتڕاست بکەرەوە.",
      steps: ["هەڵبژاردنی پاکێج", "پشتڕاستکردنەوەی باڵانس", "بەشداری لە ڕێی ئەپ یان SMS", "پشکنینی دۆخی نوێکردنەوە"]
    }
  }
};
