...
const articleDetailsCopy = {
  ...
  AR: {
    ...
    whyChargedBody: "عند السفر خارج العراق، يتصل جهازك بشبكات الشركاء المحليين بدلاً من أبراض زين. يتطلب تجوال البيانات باقات نشطة، وإلا فسيتم تطبيق أسعار الدفع الفوري القياسية. يضمن لك تأكيد إعداداتك قبل المغادرة اتصالاً سلسًا دون مفاجآت في الفاتورة.",
